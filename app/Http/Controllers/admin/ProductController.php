...
class ProductController extends Controller
{
    public function index()
    {
        ...
        $products = DB::table('products')
                    ->join('kategories', 'kategories.id', '=', 'products.kategories_id')
                    ->select('products.*', 'kategories.name as nama_kategori')
                    ->get();
        $data = array(
            'products' => $products
        );
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('image')){
            ...
            Product::create([
                ...
                'kategories_id' => $request->categories_id,
    ...
    public function update($id,Request $request)
    {
        ...
        $prod->kategories_id = $request->kategories_id;
