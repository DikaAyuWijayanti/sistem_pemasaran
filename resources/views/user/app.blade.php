...
<html lang="en">
  <head>
    <title>Welcome Batik Ciprat Langitan &mdash;Selamat Datang di Batik Ciprat Langitan Simbatan</title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <h1><strong>Welcome Batik Ciprat Langitan</strong></h1>
                <i class="icon-heart" aria-hidden="true"></i> <target="_blank" class="text-primary"><strong>Welcome To Batik Ciprat Langitan...</strong>
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy;<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> Pasar Sayur Blitar |  <i class="icon-heart" aria-hidden="true"></i> by <target="_blank" class="text-primary">BatikCiprat
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
